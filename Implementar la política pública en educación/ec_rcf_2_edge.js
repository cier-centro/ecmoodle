...
"contenido": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['0px', '-8px', '1366px', '768px', 'auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid166", tween: [ "style", "${__2_contenido_ec_rcf_2Copy2}", "top", '-12px', { fromValue: '-31px'}], position: 1250, duration: 750, easing: "easeOutBack" },
...
"lecturas": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['714px', '181px', '455px', '53px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                ...
                {
                    rect: ['714px', '234px', '455px', '69px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'guia_metodologica',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                    fill: ['rgba(255,255,255,0)']
                },
                {
                    rect: ['714px', '303px', '455px', '93px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                ...
                {
                    rect: ['714px', '396px', '455px', '47px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'formulacion_plan',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '443px', '455px', '45px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'enfoque_educacion',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                    fill: ['rgba(255,255,255,0)']
                },
                {
                    rect: ['714px', '489px', '455px', '47px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'mapas_planeacion',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '536px', '455px', '69px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'formato_formulacion',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                    fill: ['rgba(255,255,255,0)']
                },
                {
                    rect: ['714px', '613px', '455px', '83px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'enfoque_territorial',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                    cursor: ['pointer'],
                    fill: ['rgba(255,255,255,0)']
                }
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid258", tween: [ "style", "${_mapas_planeacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid247", tween: [ "style", "${_lecturas}", "right", '0px', { fromValue: '-96px'}], position: 0, duration: 500, easing: "easeOutBack" },
                { id: "eid252", tween: [ "style", "${_introduccion_politicas}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid256", tween: [ "style", "${_formulacion_plan}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid259", tween: [ "style", "${_formato_formulacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid254", tween: [ "style", "${_guia_metodologica}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid255", tween: [ "style", "${_enfoque_diferencial}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                ...
                { id: "eid257", tween: [ "style", "${_enfoque_educacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid260", tween: [ "style", "${_enfoque_territorial}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" }            ]
        }
    }
}
};
