...
"lecturas": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['714px', '270px', '455px', '109px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                ...
                {
                    rect: ['713px', '379px', '455px', '46px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                ...
                {
                    rect: ['713px', '425px', '455px', '86px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid252", tween: [ "style", "${_enfoque_diferencial}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid247", tween: [ "style", "${_lecturas}", "right", '0px', { fromValue: '-96px'}], position: 0, duration: 500, easing: "easeOutBack" },
                { id: "eid254", tween: [ "style", "${_enfoque_territorial}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid251", tween: [ "transform", "${_lecturas}", "scaleY", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeOutBack" },
                { id: "eid253", tween: [ "style", "${_enfoque_educacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
