...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['81px', '145px','96px','96px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['89px', '152px','auto','auto','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'ellipse',
                rect: ['87px', '150px','84px','84px','auto', 'auto'],
                cursor: ['pointer'],
...
"lecturas": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['714px', '421px', '455px', '57px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'mapas_planeacion',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid252", tween: [ "style", "${_mapas_planeacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
