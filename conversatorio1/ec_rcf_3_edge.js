    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    type: 'image',
                    clip: ['rect(241.964599609375px 947.1455078125px 407.0205078125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_3.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: '_2_contenido_ec_rcf_2Copy2',
                    type: 'image',
                    clip: ['rect(404.07373046875px 963.48193359375px 480.3955078125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_3.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    type: 'image',
                    clip: ['rect(479.624755859375px 963.48193359375px 657.683349609375px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_3.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
    ...
    states: {
        "Base State": {
            "${__2_contenido_ec_rcf_2Copy2}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [404.07373046875,963.48193359375,480.3955078125,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_guia_participante}": [
                ["style", "top", '410px'],
                ["style", "display", 'none'],
