...
"stage": {
    ...
    content: {
            ...
            {
                id: '_2_contenido_ec_rcf_1',
                type: 'image',
                rect: ['0', '-1px','1366px','768px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"2_contenido_ec_rcf_1.png",'0px','0px']
            },
            {
                id: 'etiqueta',
                type: 'rect',
            ...
            },
            {
                id: 'btn_next',
                type: 'image',
                rect: ['1243px', '673px','74px','74px','auto', 'auto'],
                cursor: ['pointer'],
    ...
    states: {
        "Base State": {
            ...
            "${__2_contenido_ec_rcf_1}": [
                ["style", "top", '-1px'],
                ["style", "opacity", '0']
            ],
            "${_btn_next}": [
                ["style", "top", '673px'],
                ["transform", "scaleY", '0.35845'],
                ["transform", "scaleX", '0.35845'],
                ["style", "opacity", '0'],
                ["style", "left", '1243px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid244", tween: [ "style", "${__2_contenido_ec_rcf_1}", "opacity", '1', { fromValue: '0'}], position: 750, duration: 500 },
                { id: "eid250", tween: [ "style", "${_btn_next}", "opacity", '1', { fromValue: '0'}], position: 1500, duration: 500, easing: "easeOutBack" },
                { id: "eid248", tween: [ "transform", "${_btn_next}", "scaleY", '1', { fromValue: '0.35845'}], position: 1500, duration: 500, easing: "easeOutBack" },
                { id: "eid246", tween: [ "transform", "${_btn_next}", "scaleX", '1', { fromValue: '0.35845'}], position: 1500, duration: 500, easing: "easeOutBack" }            ]
        }
    }
},
"etiqueta": {
