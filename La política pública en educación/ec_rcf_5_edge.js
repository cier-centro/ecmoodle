...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                fill: ["rgba(0,0,0,0)",im+"btn_inicio_3.png",'0px','0px']
            },
            {
                id: 'brillo',
                display: 'none',
                type: 'rect',
                rect: ['86px', '162px','auto','auto','auto', 'auto'],
            ...
            dom: [
                {
                    ...
                    type: 'image',
                    clip: ['rect(240.7578125px 947.1455078125px 443.22314453125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_5.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_5.png', '0px', '45.5146484375px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: '_2_contenido_ec_rcf_2Copy2',
                    type: 'image',
                    clip: ['rect(444.252197265625px 963.48193359375px 519.5px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_5.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    type: 'image',
                    clip: ['rect(518.03857421875px 964.42333984375px 687.16845703125px 0.94140625px)'],
                    fill: ['rgba(0,0,0,0)', 'images/2_contenido_ec_rcf_5.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                ...
                {
                    display: 'none',
                    rect: ['979px', '462px', '300px', '56px', 'auto', 'auto'],
                    borderRadius: ['10px', '10px', '10px', '10px'],
                    type: 'rect',
    ...
    states: {
        "Base State": {
            ...
            "${__2_contenido_ec_rcf_2Copy2}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [444.252197265625,963.48193359375,519.5,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_brillo_r3}": [
                ["style", "top", '410px'],
                ["style", "display", 'none']
            ...
            "${__2_contenido_ec_rcf_2Copy}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '-116px'],
                ["style", "clip", [240.7578125,947.1455078125,443.22314453125,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_brillo_r2}": [
                ["style", "top", '355px'],
                ["style", "display", 'none']
            ...
            "${__2_contenido_ec_rcf_2Copy7}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [518.03857421875,964.42333984375,687.16845703125,0.94140625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_brillo_r4}": [
                ["style", "top", '462px'],
                ["style", "display", 'none']
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid254", tween: [ "style", "${_guia_participante}", "display", 'block', { fromValue: 'none'}], position: 2000, duration: 0, easing: "easeOutBack" },
                ...
                { id: "eid255", tween: [ "style", "${_brillo_r4}", "display", 'block', { fromValue: 'none'}], position: 2750, duration: 0 },
...
"lecturas": {
            ...
            dom: [
                {
                    ...
                    fill: ['rgba(0,0,0,0)', 'images/lecturas3.png', '0px', '0px']
                },
                {
                    rect: ['714px', '298px', '455px', '80px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'politica_publica',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '378px', '455px', '46px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'acuerdo_superior',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '424px', '455px', '47px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'pnde_2016',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '471px', '455px', '59px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'plan_nacional',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid253", tween: [ "style", "${_politica_publica}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                { id: "eid263", tween: [ "style", "${_plan_nacional}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 },
                { id: "eid252", tween: [ "style", "${_acuerdo_superior}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                ...
                { id: "eid262", tween: [ "style", "${_pnde_2016}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0 }            ]
        }
    }
}
};
