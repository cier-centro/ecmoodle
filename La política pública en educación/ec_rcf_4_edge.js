...
"lecturas": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['714px', '402px', '455px', '54px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid256", tween: [ "style", "${_introduccion_politicas}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
