...
"lecturas": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['714px', '361px', '455px', '78px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
                    id: 'enfoque_derechos',
                    stroke: [0, 'rgb(0, 0, 0)', 'none'],
                ...
                {
                    rect: ['714px', '439px', '455px', '51px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid253", tween: [ "style", "${_enfoque_diferencial}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
                ...
                { id: "eid252", tween: [ "style", "${_enfoque_derechos}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
