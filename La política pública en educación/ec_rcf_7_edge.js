            ...
            dom: [
                {
                    ...
                    fill: ['rgba(0,0,0,0)', 'images/lecturas5.png', '0px', '0px']
                },
                {
                    rect: ['714px', '384px', '455px', '80px', 'auto', 'auto'],
                    display: 'none',
                    type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid252", tween: [ "style", "${_seguimiento_evaluacion}", "display", 'block', { fromValue: 'none'}], position: 500, duration: 0, easing: "easeOutBack" },
