...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   (function(symbolName) {
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         ...
         var dontTouch = 0;
         var Rd1 = new Array(1,3,dontTouch); 
         sym.setVariable("RespDrop1", Rd1);
         var Rd2 = new Array(2,5,dontTouch); 
         sym.setVariable("RespDrop2", Rd2);
         var Rd3 = new Array(3,1,dontTouch); 
         sym.setVariable("RespDrop3", Rd3);
         var Rd4 = new Array(4,6,dontTouch); 
         sym.setVariable("RespDrop4", Rd4);
         var Rd5 = new Array(5,2,dontTouch); 
         sym.setVariable("RespDrop5", Rd5);
         var Rd6 = new Array(6,4,dontTouch); 
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         //ocultar resp_correcta
								sym.$("resp_correcta").click(function(){
                    				 $(this).hide();
                    				 sym.getSymbol("bt_ayuda").stop("normal");
                    			});
						//ocultar resp_incorrecta
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 2000, function(sym, e) {
         sym.stop();
         sym.getComposition().getStage().getSymbol("contenido").play(1);
   ...
   //Edge symbol: 'etiqueta_1'
   (function(symbolName) {   
   
   })("etiqueta_1");
   //Edge symbol end:'etiqueta_1'
