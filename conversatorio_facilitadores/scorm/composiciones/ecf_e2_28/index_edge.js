...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['584px', '370px','69px','69px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['584px', '464px','69px','69px','auto', 'auto'],
                cursor: ['pointer'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['1196px', '369px','69px','69px','auto', 'auto'],
                cursor: ['pointer'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['1196px', '463px','69px','69px','auto', 'auto'],
                cursor: ['pointer'],
                borderRadius: ["5px 5px", "5px 5px", "5px 5px", "5px 5px"],
                fill: ["rgba(255,255,255,0.00)"],
                stroke: [0,"rgba(255,255,255,0.00)","none"],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['153px', '225px','1062px','280px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['155px', '226px','1062px','280px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            dom: [
                {
                    ...
                    id: 'contenido',
                    type: 'image',
                    clip: ['rect(366.884765625px 1366px 452.701904296875px 667.498046875px)'],
                ...
                },
                {
                    ...
                    id: 'contenidoCopy6',
                    type: 'image',
                    clip: ['rect(460.626708984375px 1366px 544.0283203125px 677.9814453125px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy4',
                    type: 'image',
                    clip: ['rect(369.093017578125px 610.49169921875px 452.271240234375px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy5',
                    type: 'image',
                    clip: ['rect(464.580810546875px 609.72607421875px 544.0361328125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy',
                    type: 'image',
                    clip: ['rect(158.40234375px 1366px 247.583984375px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy7',
                    type: 'image',
                    clip: ['rect(253.698974609375px 1366px 357.0546875px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
    ...
    states: {
        "Base State": {
            "${_contenidoCopy7}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [253.698974609375,1366,357.0546875,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy5}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-148px'],
                ["style", "clip", [464.580810546875,609.72607421875,544.0361328125,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy6}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-148px'],
                ["style", "clip", [460.626708984375,1366,544.0283203125,677.9814453125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenido}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-148px'],
                ["style", "clip", [366.884765625,1366,452.701904296875,667.498046875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy3}": [
                ["style", "top", '1px'],
                ["style", "opacity", '0'],
            ...
            "${_contenidoCopy4}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '-148px'],
                ["style", "clip", [369.093017578125,610.49169921875,452.271240234375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '768px'],
                ["style", "width", '1366px']
            ...
            "${_contenidoCopy}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [158.40234375,1366,247.583984375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy2}": [
                ["style", "top", '1px'],
                ["style", "opacity", '0'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid1426", tween: [ "style", "${_contenidoCopy7}", "top", '0px', { fromValue: '-52px'}], position: 500, duration: 500, easing: "easeOutBack" },
                { id: "eid1427", tween: [ "style", "${_contenidoCopy7}", "opacity", '1', { fromValue: '0'}], position: 500, duration: 500, easing: "easeOutBack" },
