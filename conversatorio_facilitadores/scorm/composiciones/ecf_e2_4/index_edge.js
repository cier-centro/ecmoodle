...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                clip: ['rect(93.29736328125px 697.1962890625px 150.989990234375px -0.798828125px)'],
            ...
            },
            {
                ...
                clip: ['rect(93.29736328125px 1198.94580078125px 150.989990234375px 695.64990234375px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'pop_1',
                type: 'rect',
                rect: ['265px', '222px','auto','auto','auto', 'auto']
            },
            {
                id: 'pop_2',
                type: 'rect',
                rect: ['265', '172px','auto','auto','auto', 'auto']
            }],
            symbolInstances: [
            {
                id: 'btn_1',
    ...
    states: {
        "Base State": {
            ...
            "${_instruccion}": [
                ["style", "opacity", '0'],
                ["style", "left", '-109px'],
                ["style", "clip", [93.29736328125,1198.94580078125,150.989990234375,695.64990234375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_hotspot_2}": [
                ["style", "top", '438px'],
            ...
            "${_txt_etiqueta}": [
                ["style", "opacity", '0'],
                ["style", "left", '-92px'],
                ["style", "clip", [93.29736328125,697.1962890625,150.989990234375,-0.798828125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_btn_1}": [
                ["style", "top", '264px'],
                ["style", "left", '-670px'],
            ...
            dom: [
                {
                    ...
                    id: 'contenido',
                    type: 'image',
                    clip: ['rect(272.230224609375px 968.01513671875px 395.193115234375px 399.44091796875px)'],
    ...
    states: {
        "Base State": {
            ...
            "${_contenido}": [
                ["style", "top", '-274px'],
                ["style", "left", '-400px'],
                ["style", "clip", [272.230224609375,968.01513671875,395.193115234375,399.44091796875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '120px'],
                ["style", "width", '600px']
            ...
            dom: [
                {
                    ...
                    id: 'contenidoCopy',
                    type: 'image',
                    clip: ['rect(400.72802734375px 1074.8154296875px 523.12255859375px 318.83056640625px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    id: 'brillo_1',
    ...
    states: {
        "Base State": {
            ...
            "${_contenidoCopy}": [
                ["style", "top", '-403px'],
                ["style", "left", '-321px'],
                ["style", "clip", [400.72802734375,1074.8154296875,523.12255859375,318.83056640625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '120px'],
                ["style", "width", '750px']
...
"pop_1": {
    ...
    content: {
            dom: [
                {
                    type: 'image',
                    rect: ['-15px', '26px', '868px', '280px', 'auto', 'auto'],
                    display: 'none',
                    id: 'pop_1',
                ...
                {
                    rect: ['922px', '46px', '58px', '58px', 'auto', 'auto'],
                    type: 'ellipse',
...
"pop_2": {
    ...
    content: {
            dom: [
                {
                    rect: ['-95px', '72px', '1006px', '280px', 'auto', 'auto'],
                    transform: [[0, 0], [], [], ['1.13519', '1.62857']],
                    type: 'image',
                    id: 'pop_22',
                    display: 'none',
                ...
                {
                    rect: ['911px', '-5px', '58px', '58px', 'auto', 'auto'],
                    type: 'ellipse',
                    borderRadius: ['50%', '50%', '50%', '50%'],
                    id: 'cerrar',
                    display: 'none',
