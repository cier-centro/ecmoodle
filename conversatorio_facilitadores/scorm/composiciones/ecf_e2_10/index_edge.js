...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                clip: ['rect(245.7529296875px 924.53564453125px 456.56396484375px 0px)'],
            ...
            },
            {
                ...
                clip: ['rect(456.56201171875px 976.95703125px 544.72607421875px 733.00439453125px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'character',
                ...
                clip: ['rect(-14.924072265625px 339.4747619628906px 388.167236328125px -56.4265022277832px)'],
                transform: [[],[],[],['-1.01501']]
            },
            {
                id: 'brillo',
                type: 'rect',
                rect: ['900px', '474px','auto','auto','auto', 'auto']
            },
            {
                id: 'hotspot_r',
                display: 'none',
                type: 'rect',
                rect: ['747px', '476px','222px','52px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                type: 'image',
                rect: ['0px', '0px','1366px','768px','auto', 'auto'],
                clip: ['rect(103.107421875px 1002.22900390625px 145.432373046875px 354.65185546875px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'texto_etiqueta',
    ...
    states: {
        "Base State": {
            ...
            "${_instruccion}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '-129px'],
                ["style", "clip", [103.107421875,1002.22900390625,145.432373046875,354.65185546875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_texto_etiqueta}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
            ...
            "${_contenido}": [
                ["style", "clip", [245.7529296875,924.53564453125,456.56396484375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "top", '519px']
            ],
            "${_character}": [
                ["transform", "scaleX", '-1.01501'],
                ["style", "left", '926px'],
                ["style", "clip", [-14.924072265625,339.4747619628906,388.167236328125,-56.4265022277832], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "top", '236px']
            ],
            "${_Stage}": [
            ...
            "${_contenidoCopy2}": [
                ["style", "opacity", '0'],
                ["style", "left", '-164px'],
                ["style", "clip", [456.56201171875,976.95703125,544.72607421875,733.00439453125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ]
        }
    },
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid28", tween: [ "style", "${_instruccion}", "left", '19px', { fromValue: '-129px'}], position: 435, duration: 500, easing: "easeOutBack" },
