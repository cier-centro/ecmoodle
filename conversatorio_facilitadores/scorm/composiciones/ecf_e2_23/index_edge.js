...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Drop_1',
                type: 'rect',
                rect: ['1002px', '476px','70px','70px','auto', 'auto'],
            ...
            },
            {
                id: 'Drop_2',
                type: 'rect',
                rect: ['1121px', '477px','70px','70px','auto', 'auto'],
                fill: ["rgba(197,197,197,0.00)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['405px', '408px','71px','71px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['680px', '408px','71px','71px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['278px', '329px','71px','71px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['553px', '329px','71px','71px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['834px', '331px','71px','71px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['187px', '225px','994px','276px','auto', 'auto'],
                cursor: ['pointer'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid817", tween: [ "style", "${_Drag_4}", "display", 'block', { fromValue: 'none'}], position: 1000, duration: 0, easing: "easeOutBack" },
                { id: "eid827", tween: [ "style", "${_Drag_5}", "left", '832px', { fromValue: '832px'}], position: 1943, duration: 0, easing: "easeOutBack" },
                { id: "eid762", tween: [ "style", "${_help}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid824", tween: [ "style", "${_Drag_3}", "left", '276px', { fromValue: '276px'}], position: 1943, duration: 0, easing: "easeOutBack" },
                { id: "eid764", tween: [ "style", "${_resp_incorrecta}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid825", tween: [ "style", "${_Drag_2}", "left", '678px', { fromValue: '678px'}], position: 1943, duration: 0, easing: "easeOutBack" },
                { id: "eid815", tween: [ "style", "${_Drag_2}", "display", 'block', { fromValue: 'none'}], position: 1000, duration: 0, easing: "easeOutBack" },
                { id: "eid828", tween: [ "style", "${_Drag_1}", "left", '403px', { fromValue: '403px'}], position: 1943, duration: 0, easing: "easeOutBack" },
                { id: "eid826", tween: [ "style", "${_Drag_4}", "left", '551px', { fromValue: '551px'}], position: 1943, duration: 0, easing: "easeOutBack" },
                { id: "eid818", tween: [ "style", "${_Drag_5}", "display", 'block', { fromValue: 'none'}], position: 1000, duration: 0, easing: "easeOutBack" },
                { id: "eid814", tween: [ "style", "${_Drag_1}", "display", 'block', { fromValue: 'none'}], position: 1000, duration: 0, easing: "easeOutBack" }            ]
        }
    }
},
"ok": {
    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    id: 'contenidoCopy',
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    clip: ['rect(176.1162109375px 1366px 272.408203125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    type: 'image',
                    id: 'contenidoCopy2',
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    clip: ['rect(320.88916015625px 913.1728515625px 509.480224609375px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    type: 'image',
                    id: 'contenidoCopy3',
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    clip: ['rect(272.8330078125px 1355.880859375px 632.8525390625px 924.8974609375px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                }
            ],
            symbolInstances: [
    ...
    states: {
        "Base State": {
            ...
            "${_contenidoCopy3}": [
                ["style", "top", '514px'],
                ["style", "left", '0px'],
                ["style", "clip", [272.8330078125,1355.880859375,632.8525390625,924.8974609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy4}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
            ...
            "${_contenidoCopy}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '0px'],
                ["style", "clip", [176.1162109375,1366,272.408203125,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy2}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-369px'],
                ["style", "clip", [320.88916015625,913.1728515625,509.480224609375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ]
        }
    },
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid799", tween: [ "style", "${_contenidoCopy4}", "left", '7px', { fromValue: '-86px'}], position: 250, duration: 500, easing: "easeOutBack" },
                { id: "eid797", tween: [ "style", "${_contenido}", "left", '0px', { fromValue: '-86px'}], position: 321, duration: 500, easing: "easeOutBack" },
