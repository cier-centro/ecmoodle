...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'etiqueta',
                type: 'rect',
                rect: ['119px', '82','auto','auto','auto', 'auto']
            },
            {
                id: 'contenido',
                type: 'rect',
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['790px', '466px','50px','50px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['1162px', '468px','50px','50px','auto', 'auto'],
                cursor: ['pointer'],
                borderRadius: ["50% 50%", "50% 50%", "50% 50%", "50% 50%"],
                fill: ["rgba(150,150,150,0.00)"],
                stroke: [1,"rgba(139,139,139,0.50)","none"],
...
"contenido": {
            ...
            dom: [
                {
                    ...
                    id: 'contenido',
                    type: 'image',
                    clip: ['rect(0px 965.6630859375px 152.512939453125px 417.44775390625px)'],
                ...
                },
                {
                    ...
                    id: 'contenidoCopy2',
                    type: 'image',
                    clip: ['rect(274.371826171875px 489.0390625px 631.93994140625px 68.8798828125px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy3',
                    type: 'image',
                    clip: ['rect(449.624755859375px 1201.96044921875px 536.910888671875px 885.79931640625px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy6',
                    type: 'image',
                    clip: ['rect(449.387451171875px 803.76025390625px 531.1357421875px 484.11474609375px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    id: 'contenidoCopy4',
                    type: 'image',
                    clip: ['rect(278.5234375px 1240.3642578125px 438.197998046875px 523.55224609375px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['99px', '177px', 'auto', 'auto', 'auto', 'auto'],
                    id: 'character',
                    transform: [[], [], [], ['-0.84309', '0.84344']],
    ...
    states: {
        "Base State": {
            ...
            "${_contenidoCopy2}": [
                ["style", "top", '0px'],
                ["style", "left", '0px'],
                ["style", "clip", [274.371826171875,489.0390625,631.93994140625,68.8798828125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy6}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-186px'],
                ["style", "clip", [449.387451171875,803.76025390625,531.1357421875,484.11474609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenido}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-43px'],
                ["style", "clip", [0,965.6630859375,152.512939453125,417.44775390625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy3}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-186px'],
                ["style", "clip", [449.624755859375,1201.96044921875,536.910888671875,885.79931640625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy4}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "left", '-186px'],
                ["style", "clip", [278.5234375,1240.3642578125,438.197998046875,523.55224609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '884px'],
                ["style", "width", '1366px']
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid1174", tween: [ "style", "${_contenidoCopy3}", "left", '-8px', { fromValue: '-186px'}], position: 750, duration: 500, easing: "easeOutBack" },
                { id: "eid1162", tween: [ "style", "${_contenido}", "opacity", '1', { fromValue: '0'}], position: 335, duration: 500, easing: "easeOutCirc" },
                { id: "eid1181", tween: [ "style", "${_contenidoCopy6}", "left", '22px', { fromValue: '-186px'}], position: 825, duration: 500, easing: "easeOutBack" },
