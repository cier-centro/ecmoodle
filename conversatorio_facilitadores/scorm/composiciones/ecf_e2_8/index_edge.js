...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                clip: ['rect(326.21630859375px 1320.998046875px 530.775146484375px 0px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'contenidoCopy2',
            ...
            },
            {
                ...
                type: 'image',
                rect: ['0px', '0px','1366px','768px','auto', 'auto'],
                clip: ['rect(103.107421875px 1022.560546875px 145.432373046875px 354.65185546875px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'texto_etiqueta',
    ...
    states: {
        "Base State": {
            ...
            "${_instruccion}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '-129px'],
                ["style", "clip", [103.107421875,1022.560546875,145.432373046875,354.65185546875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_texto_etiqueta}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
            ...
            "${_contenidoCopy}": [
                ["style", "top", '122px'],
                ["style", "opacity", '0'],
                ["style", "clip", [326.21630859375,1320.998046875,530.775146484375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_character}": [
                ["style", "top", '241px'],
                ["style", "left", '188px'],
