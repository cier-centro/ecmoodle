...
"stage": {
    ...
    content: {
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['82px', '144px','96px','96px','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['90px', '152px','auto','auto','auto', 'auto'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'ellipse',
                rect: ['90px', '153px','84px','84px','auto', 'auto'],
                cursor: ['pointer'],
...
"contenido": {
    ...
    content: {
            dom: [
                ...
                {
                    rect: ['0px', '-27px', '1366px', '768px', 'auto', 'auto'],
                ...
                {
                    display: 'none',
                    rect: ['979px', '356px', '300px', '56px', 'auto', 'auto'],
                    borderRadius: ['10px', '10px', '10px', '10px'],
                    type: 'rect',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid239", tween: [ "style", "${_guia_participante}", "display", 'block', { fromValue: 'none'}], position: 2000, duration: 0, easing: "easeOutBack" },
