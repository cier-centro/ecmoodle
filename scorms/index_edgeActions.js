...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_2" ).append( "<iframe src='composiciones/ecf_e1_2/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
         sym.$("miga").show();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 2000, function(sym, e) {
        ...
        $(sym.lookupSelector("textCount")).html("2 - 12"); 
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
        $( "#Stage_slide_3" ).append( "<iframe src='composiciones/ecf_e1_3/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 3000, function(sym, e) {
        ...
        //sym.getSymbol("miga").stop(750);
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga 
        $( "#Stage_slide_4" ).append( "<iframe src='composiciones/ecf_e1_4/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" )
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_5" ).append( "<iframe src='composiciones/ecf_e1_5/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      $(sym.lookupSelector("textCount")).html("5 - 12");
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
      $( "#Stage_slide_6" ).append( "<iframe src='composiciones/ecf_e1_6/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 6000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_7" ).append( "<iframe src='composiciones/ecf_e1_7/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_8" ).append( "<iframe src='composiciones/ecf_e1_8/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 8000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_9" ).append( "<iframe src='composiciones/ecf_e1_9/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 9000, function(sym, e) {
         ...
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $( "#Stage_slide_10" ).append( "<iframe src='composiciones/ecf_e1_10/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 10000, function(sym, e) {
         ...
         $( "#Stage_slide_11" ).append( "<iframe src='composiciones/ecf_e1_11/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 11000, function(sym, e) {
         ...
         $( "#Stage_slide_12" ).append( "<iframe src='composiciones/ecf_e1_12/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 12000, function(sym, e) {
         ...
         //$("#Stage_slide_"+(slideCount+1)).children().remove();
         //cargar actividad-reemplazar la carpeta según el código - cambiar el simbolo de acuerdo a donde carga
         $(sym.lookupSelector("textCount")).html("12 - 12");
          $( "#Stage_slide_13" ).append( "<iframe src='composiciones/B02_13/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 13000, function(sym, e) {
         ...
         $( "#Stage_slide_14" ).append( "<iframe src='composiciones/B02_14/index.html' width='1366px' height='768px' frameborder='0' scrolling='no'></iframe>" );
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hotspot_go10}", "click", function(sym, e) {
         sym.stop("slide_10");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hotspot_e1}", "click", function(sym, e) {
         sym.stop("slide_5");
