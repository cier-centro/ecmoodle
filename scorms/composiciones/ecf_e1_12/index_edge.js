...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'background',
                type: 'image',
                rect: ['-80px', '2px','1366px','768px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"background.png",'0px','0px']
            },
            {
                id: 'contenido',
                type: 'image',
                rect: ['-46px', '0','1366px','768px','auto', 'auto'],
                clip: ['rect(185.64453125px 1320.998046875px 365.141357421875px 0px)'],
            ...
            },
            {
                id: 'character',
                type: 'rect',
                rect: ['155px', '241px','auto','auto','auto', 'auto'],
                clip: ['rect(0px 313.03271484375px 383.21923828125px -62.419921875px)']
            },
            {
                id: 'brillo',
                type: 'rect',
                rect: ['1165', '534','auto','auto','auto', 'auto']
            },
            {
                id: 'hotspot_r',
                display: 'none',
    ...
    states: {
        "Base State": {
            ...
            "${_contenido}": [
                ...
                ["style", "opacity", '0'],
                ["style", "clip", [185.64453125,1320.998046875,365.141357421875,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-46px']
            ],
            "${_character}": [
                ["style", "top", '241px'],
                ["style", "left", '155px'],
                ["style", "clip", [0,313.03271484375,383.21923828125,-62.419921875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_Stage}": [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid84", tween: [ "style", "${_titulo}", "left", '-231px', { fromValue: '-323px'}], position: 500, duration: 500, easing: "easeOutBack" },
