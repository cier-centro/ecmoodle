...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                clip: ['rect(164.51318359375px 1320.998046875px 354.088134765625px 0px)'],
            ...
            },
            {
                ...
                clip: ['rect(465.314453125px 980.2080078125px 540.03466796875px 746.7587890625px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'brillo',
                type: 'rect',
                rect: ['914px', '468px','auto','auto','auto', 'auto']
            },
            {
                id: 'character_1',
                type: 'rect',
            ...
            },
            {
                ...
                display: 'none',
                type: 'rect',
                rect: ['760px', '461px','222px','69px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                type: 'image',
                rect: ['0px', '0px','1366px','768px','auto', 'auto'],
                clip: ['rect(103.107421875px 648.30615234375px 145.432373046875px 403.11474609375px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'texto_etiqueta',
            ...
            },
            {
                ...
                type: 'image',
                rect: ['0px', '0px','1366px','768px','auto', 'auto'],
                clip: ['rect(103.107421875px 796.93896484375px 145.432373046875px 655.74365234375px)'],
                fill: ["rgba(0,0,0,0)",im+"contenido.png",'0px','0px']
            },
            {
                id: 'pop_1',
    ...
    states: {
        "Base State": {
            ...
            "${_btn_reflexion}": [
                ["style", "opacity", '0'],
                ["style", "left", '-164px'],
                ["style", "clip", [465.314453125,980.2080078125,540.03466796875,746.7587890625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_hotspot_r}": [
                ["style", "top", '461px'],
                ["style", "display", 'none'],
            ...
            "${_instruccion}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '-129px'],
                ["style", "clip", [103.107421875,648.30615234375,145.432373046875,403.11474609375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_contenidoCopy}": [
                ...
                ["style", "opacity", '0'],
                ["style", "clip", [164.51318359375,1320.998046875,354.088134765625,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "top", '0px']
            ],
            "${_titulo}": [
                ["style", "top", '0px'],
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [103.107421875,796.93896484375,145.432373046875,655.74365234375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-129px']
            ]
        }
    },
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid153", tween: [ "style", "${_titulo}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
