...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                clip: ['rect(245.7529296875px 935.47314453125px 478.498046875px 0px)'],
    ...
    states: {
        "Base State": {
            ...
            "${_contenido}": [
                ["style", "clip", [245.7529296875,935.47314453125,478.498046875,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "top", '519px']
            ],
            "${_etiqueta}": [
                ["style", "left", '0px'],
    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    display: 'none',
                    id: 'eyesCopy2',
                    clip: ['rect(496.640380859375px 204.19140625px 508.561767578125px 146.1171875px)'],
    ...
    states: {
        "Base State": {
            "${_eyesCopy2}": [
                ["style", "top", '-489px'],
                ["style", "display", 'none'],
                ["style", "clip", [496.640380859375,204.19140625,508.561767578125,146.1171875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
