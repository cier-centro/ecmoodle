...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Drop_1',
                type: 'rect',
                rect: ['318px', '355px','133px','28px','auto', 'auto'],
            ...
            },
            {
                id: 'Drop_2',
                type: 'rect',
                rect: ['613px', '514px','133px','28px','auto', 'auto'],
                fill: ["rgba(197,197,197,1.00)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                id: 'Drop_3',
                type: 'rect',
                rect: ['923px', '347px','133px','28px','auto', 'auto'],
                fill: ["rgba(197,197,197,1.00)"],
                stroke: [0,"rgb(0, 0, 0)","none"]
            },
            {
                id: 'Drag_6',
                type: 'image',
                rect: ['1184px', '228px','132px','28px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                id: 'Drag_5',
                type: 'image',
                rect: ['901px', '228px','132px','28px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                id: 'Drag_4',
                type: 'image',
                rect: ['900px', '190px','132px','29px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                id: 'Drag_3',
                type: 'image',
                rect: ['1044px', '228px','133px','28px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                id: 'Drag_2',
                type: 'image',
                rect: ['1184px', '191px','132px','28px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                id: 'Drag_1',
                type: 'image',
                rect: ['1044px', '191px','133px','28px','auto', 'auto'],
                cursor: ['move'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['437px', '245px','497px','234px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                display: 'none',
                type: 'image',
                rect: ['146px', '173px','1078px','366px','auto', 'auto'],
                cursor: ['pointer'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid821", tween: [ "style", "${_resp_correcta}", "display", 'none', { fromValue: 'none'}], position: 5624, duration: 0 },
                { id: "eid764", tween: [ "style", "${_resp_incorrecta}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid822", tween: [ "style", "${_resp_incorrecta}", "display", 'none', { fromValue: 'none'}], position: 5624, duration: 0 },
...
"etiqueta_1": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid1385", tween: [ "style", "${_etiqueta}", "left", '214px', { fromValue: '-210px'}], position: 125, duration: 625, easing: "easeOutBack" },
                ...
                { id: "eid1377", tween: [ "style", "${_etiquetaCopy2}", "left", '214px', { fromValue: '-210px'}], position: 0, duration: 625, easing: "easeOutBack" },
                { id: "eid1381", tween: [ "style", "${_etiquetaCopy}", "left", '214px', { fromValue: '-210px'}], position: 62, duration: 625, easing: "easeOutBack" }            ]
        }
    }
},
"contenido": {
            ...
            dom: [
                {
                    ...
                    clip: ['rect(171.810302734375px 1373.07763671875px 550.743408203125px 3.2646484375px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    type: 'image',
                    id: 'instruccion',
                    rect: ['-32px', '-14px', '1366px', '768px', 'auto', 'auto'],
                    clip: ['rect(105.9638671875px 1354.7373046875px 167.333251953125px 429.97607421875px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    type: 'image',
    ...
    states: {
        "Base State": {
            ...
            "${_contenido2}": [
                ["style", "top", '-51px'],
                ["style", "opacity", '0'],
                ["style", "clip", [171.810302734375,1373.07763671875,550.743408203125,3.2646484375], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '0px']
            ],
            "${_instruccion}": [
                ["style", "top", '-14px'],
                ["style", "opacity", '0'],
                ["style", "left", '-120px'],
                ["style", "clip", [105.9638671875,1354.7373046875,167.333251953125,429.97607421875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${symbolSelector}": [
                ["style", "height", '768px'],
                ["style", "width", '1366px']
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid796", tween: [ "style", "${_instruccion}", "opacity", '1', { fromValue: '0'}], position: 250, duration: 500, easing: "easeOutBack" },
                { id: "eid798", tween: [ "style", "${_contenido2Copy2}", "opacity", '1', { fromValue: '0'}], position: 250, duration: 500, easing: "easeOutBack" },
                { id: "eid792", tween: [ "style", "${_instruccion}", "left", '-43px', { fromValue: '-120px'}], position: 250, duration: 500, easing: "easeOutBack" },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid819", tween: [ "transform", "${_cabello}", "rotateZ", '0deg', { fromValue: '-2deg'}], position: 6000, duration: 500 },
                { id: "eid122", tween: [ "transform", "${_cabello}", "rotateZ", '-2deg', { fromValue: '0deg'}], position: 7000, duration: 500 },
